...
try:
    ...
    if openai_key:
        ...
        print("OpenAI Extractor (GPT-4o, Pakistan profile) initialized.")
...
def process_invoice(file_path: Path, file_id: str):
    """
    Orchestrates invoice extraction using OpenAI GPT-4o, then runs Pakistan-specific
    GST processing and pushes to Sheets + QuickBooks.
    """
